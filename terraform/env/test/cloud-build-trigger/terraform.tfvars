...
cloud_build_triggers = {
  cloud_build_trigger_01 = {
    project         = "springboot-java-cloud-deploy"
    ...
    service_account = "projects/springboot-java-cloud-deploy/serviceAccounts/sa-jasgeet@springboot-java-cloud-deploy.iam.gserviceaccount.com"
